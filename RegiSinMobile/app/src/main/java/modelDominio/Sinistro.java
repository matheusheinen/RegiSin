...
public class Sinistro implements Serializable {
    ...
    public Sinistro(Usuario usuario, TipoSinistro tipoSinistro, String cidadeSinistro, String enderecoSinistro, String situacaoSinistro, String descricaoSinistro, String dataSinistro, Evento evento, byte[] imagemSinistro) {
        this.usuario = usuario;
        this.tipoSinistro = tipoSinistro;
        this.cidadeSinistro = cidadeSinistro;
        this.enderecoSinistro = enderecoSinistro;
